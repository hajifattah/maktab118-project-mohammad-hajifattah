...
export const StoreStockChanges: React.FC = () => {
  ...
  const { removePair, pairs } = useContext(PairStockContext);
  const storeChanges = () => {};
  return (
    <div>
      <button
            ...
            >
              <div className="bg-sky-500 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:flex-col  sm:gap-y-5 ">
                  ...
                  <table
                    className="gap-y-4 rounded-md rtl:text-right w-full bg-blue_app"
                    dir="rtl"
                  >
                    <tr className="p-2">
                    ...
                    {pairs.map((item) => (
                      <tr key={item.id} className="text-slate-200">
                        ...
                        <td className="font-bold px-6 py-3">
                          <button className="text-red-500 hover:text-red-300 p-2 ">حذف</button>
                        </td>
                      </tr>
                    ))}
                  </table>
